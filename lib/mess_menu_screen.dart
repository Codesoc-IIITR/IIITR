...
class _MessMenuScreenState extends State<MessMenuScreen> {
  ...
  Widget build(BuildContext context) {
    final MessMenuScreenArguments args =
            ...
            builder: (context, snapshot) {
              ...
              try {
                ...
                lunch.forEach((key, value) =>
                    lunchItems.add(MenuTextWidget(value: value)));

                snacks.forEach((key, value) =>
                    snacksItems.add(MenuTextWidget(value: value)));

                dinner.forEach((key, value) =>
                    dinnerItems.add(MenuTextWidget(value: value)));
              } catch (e) {
                print(e.toString());
              }
